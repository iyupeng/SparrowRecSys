...
public class Config {
    ...
    public static String MYSQL_DB_CONNECTION_URL =
            "jdbc:mysql://demo-recsys-data:3306/sparrow_recsys?" +
            "user=sparrow&password=Recsys1$&autoReconnect=true";

    public static String REDIS_SERVER = "demo-recsys-data";
    public static int REDIS_PORT = 6379;

    public static String KAFKA_BROKER_SERVERS = "demo-recsys-data:9092";
    public static String HDFS_PATH_ALL_MOVIES = "hdfs://demo-recsys-data:8020/sparrow_recsys/movies/";
    public static String HDFS_PATH_ALL_RATINGS = "hdfs://demo-recsys-data:8020/sparrow_recsys/ratings/";
    public static String HDFS_PATH_SAMPLE_DATA = "hdfs://demo-recsys-data:8020/sparrow_recsys/sampledata/";
    public static String HDFS_PATH_MODEL_DATA = "hdfs://demo-recsys-data:8020/sparrow_recsys/modeldata/";
